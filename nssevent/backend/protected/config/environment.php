...
define('CORE_FOLDER',dirname(__FILE__).'/../../../../gxc-cms-2-master/core');
...
class Environment {
   ...
   private function _development () {
          ...
          define('SITE_PATH','http://bd.nssevent.vn');
          define('RESOURCE_URL','http://resources.nssevent.vn');
          ...
          return array(
               ...
               'modules'=>array(
                       'gii'=>array(
                               ...
                               'password'=>'123456',
                               'ipFilters'=>array('192.168.169.26'),
                               'newFileMode'=>0666,
                               'newDirMode'=>0777,
               ...
               'components' => array(
                  ...
                  // Database
                    'db'=>array(
                    'connectionString' => 'mysql:host=localhost;dbname=nssevent',
   ...
   private function _test() {
      ...
      define('SITE_PATH','http:/.nssevent.vn/backend/');
      define('RESOURCE_URL','http://resources.nssevent.vn');
      define('RESOURCES_FOLDER',dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR.'resources');
