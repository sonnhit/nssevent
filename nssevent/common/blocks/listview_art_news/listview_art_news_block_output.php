<?php if($this->display_type==ListViewArtNewsBlock::DISPLAY_TYPE_HOMEPAGE) : ?>
	<?php if ($this->content_list != null) : ?>
		<?php
				//So I get the first content list and want to return as a Data Provider
                $content_list_data_provider = ListViewArtNewsBlock::getContentList($this->content_list[0], null , null, ConstantDefine::CONTENT_LIST_RETURN_DATA_PROVIDER);
                ...
                if (isset($content_list_data_provider) && $content_list_data_provider != null) : ?>
                    	...
                    	$this->widget('zii.widgets.CListView',
                                  ...
                                  (
                                    ...
                                    'itemView'=>'common.blocks.listview_art_news.item_render',
                                    'summaryText'=>'',
                                    'ajaxUpdate'=>true,
