...
class DetailNewsBlock extends CWidget
{

    //Do not delete these attr block, page and errors
    public $id='detail_news';
    public $block=null;
    public $errors=array();
    public $page=null;
    public $layout_asset='';
    ...
    protected function renderContent()
    {
       if(isset($this->block) && ($this->block!=null)){
                ...
                if($post_id){
                    ...
                    $post_new = Object::model()->findByPk((int)$max['object_id']);
                    if($post){
                        ...
                        if ($post_new){
                            $this->render(BlockRenderWidget::setRenderOutput($this),array('post'=>$post,'post_new'=>$post_new));
                        }
                        else {
