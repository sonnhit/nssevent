...
class MenuFooterListBlock extends CWidget
{

    //Do not delete these attr block, page and errors
    public $id='menu_footer_list';
    public $block=null;
    public $errors=array();
    public $page=null;
    public $layout_asset='';
    ...
    protected function renderContent()
    {
       if (isset($this->block) && ($this->block!=null)) {
                ...
                if($menu_r0_items===false){
                    ...
                    foreach ($menu_r0_items as $key) {
                      $menu_r1_items[] = self::getMenuItems((int)$key['id'],$this->menu_id);
                    }

                    //Yii::app()->cache->set('menu_r0_'.$this->menu_id,$menu_r0_items,7200);
                }

                $this->render(BlockRenderWidget::setRenderOutput($this),array('menus'=>$menu_r0_items,'menus_sub'=>$menu_r1_items
                    ));
        } else {
            echo '';
        }
